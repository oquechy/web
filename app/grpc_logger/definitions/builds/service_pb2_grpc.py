...
class LogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Log = channel.unary_unary(
                '/LogService/Log',
                request_serializer=service__pb2.Msg.SerializeToString,
...
def add_LogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Log': grpc.unary_unary_rpc_method_handler(
                    servicer.Log,
                    request_deserializer=service__pb2.Msg.FromString,
...
class LogService(object):
    ...
    def Log(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LogService/Log',
            service__pb2.Msg.SerializeToString,
